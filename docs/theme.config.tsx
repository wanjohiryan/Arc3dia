...
const config: DocsThemeConfig = {
  project: {
    link: 'https://github.com/wanjohiryan/arc3dia'
  },
  docsRepositoryBase: 'https://github.com/wanjohiryan/arc3dia/tree/main/docs',
  useNextSeoProps() {
    const { asPath } = useRouter()
    if (asPath !== '/') {
      return {
        titleTemplate: '%s – Arc3dia'
      }
    }
  },
  logo,
  head: function useHead() {
    ...
    return (
      <>
        ...
        <meta name="twitter:site:domain" content="arc3dia.com" />
        <meta name="twitter:url" content="https://dev.arc3dia.com" />
        <meta
          name="og:title"
          content={title ? title + ' – Arc3dia' : 'Arc3dia'}
        />
        <meta name="og:image" content={socialCard} />
        <meta name="apple-mobile-web-app-title" content="Arc3dia" />
        {/**TODO:Fix this */}
